...
% We report two variants of precision, recall and F-score. 
% The first one is calculated in a straight-forward way: all readings that 
% are not the uniquely correct one, reduce the precision. The second variant 
% is more tolerant to ambiguity, if the rule preserves other readings that 
% have the same POS as the correct reading. 
...
% \multicolumn{1}{|l|}{\textbf{Original grammar}}  & \~{}92          & \~{}68           & \~{}78       &  98.25        &  87.01         &  92.29           \\ \hline
% \multicolumn{1}{|l|}{\textbf{ML-tuned original}} & \~{}94          & \~{}72           & \~{}82       &  97           &  89.10         &  92.88           \\ \hline
% \end{tabular}
% \end{table*}
